...
这是一个功能齐全的在线文本编辑器应用，提供直观的文件管理和编辑功能。应用采用前后端分离架构，前端基于React+zustand和TypeScript开发，后端使用Node.js和Express提供文件管理API，支持本地开发和Vercel部署。

### 公网链接

本项目部署在Vercel平台：**[https://www.newbox.asia/](https://www.newbox.asia)**
...
由于浏览器安全策略要求，本地开发环境需要配置有效的SSL证书以避免混合内容警告。我们使用mkcert工具生成自签名证书。
